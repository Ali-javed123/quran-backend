...
import { getSurahs, getAyahsBySurah, getParas, getAyahsByPara, getParaByPage, getSurahByPage, getSurahMeta, getParaMeta, clearQuranCacheController } from '../controllers/quranController.js';
...
router.delete("/cache/clear", clearQuranCacheController);
